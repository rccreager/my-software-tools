...
void print_summary_HIST_WP_TAG_DATASET() {
    ...
    float b_val_1 = l1->GetBinContent(1);
    float b_val_2 = l2->GetBinContent(2);
    float b_val_3 = l3->GetBinContent(3);
    float b_val_4 = l4->GetBinContent(4);
    float b_val_5 = l5->GetBinContent(5);
    float b_val_6 = l6->GetBinContent(6);
    float b_val_7 = l7->GetBinContent(7);
    float b_val_8 = l8->GetBinContent(8);
    float b_val_9 = l9->GetBinContent(9);        

    cout << "HIST for WP DATASET" << endl;
    cout <<  b_val_1 << endl;
    cout <<  b_val_2 << endl;
    cout <<  b_val_3 << endl;
    cout <<  b_val_4 << endl;
